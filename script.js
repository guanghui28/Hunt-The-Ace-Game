...
const createCard = (cardItem) => {
    ...
    // add front image element as child element of front of card
    addChildElement(cardFrontElem, cardFrontImg);

    // add back image element as child element to  back  card
    addChildElement(cardBackElem, cardBackImg);

    // add back card element as child element  to inner  card
    addChildElement(cardInnerElem, cardBackElem);

    // add front card element as child element  to inner  card
...
function addCardsToGridAreaCell(cellPositionClassName) {
    const cardPositionElem = document.querySelector(cellPositionClassName);
...
function getObjectFromJSON(obj) {
